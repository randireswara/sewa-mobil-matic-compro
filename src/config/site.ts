...
const waNumber = import.meta.env.PUBLIC_WHATSAPP_NUMBER || '6281234567890';
...
export const siteConfig: SiteConfig = {
  ...
  description: 'Layanan rental mobil matic terpercaya untuk kebutuhan harian dan bulanan di area BSD, Tangerang Selatan, Alam Sutera, Jakarta, dan sekitarnya.',
  ...
  defaultSeo: {
    ...
    description: 'Sewa mobil matic harian dan bulanan terpercaya area BSD City, Tangerang Selatan, Alam Sutera, & Jakarta. Armada terawat, proses transparan & mudah.',
  }
};
...
export function getWhatsAppUrl(message?: string): string {
  const defaultMsg = 'Halo Sewa Mobil Matic, saya ingin menanyakan informasi sewa mobil.';
